...
function getCoordinator() {
    if (!coordinatorAgent) {
        coordinatorAgent = new CoordinatorAgent_1.CoordinatorAgent();
    }
    ...
    try {
        ...
        res.json({
            ...
            progress: {
                ...
                percentage: Math.round((taskState.subtasks.filter(t => t.status === 'completed').length / taskState.subtasks.length) * 100)
            },
 ...
 */
function calculateDuration(taskState) {
